    ...
    <>
      ...
      <main className="w-full min-h-screen pt-32 pb-20 px-6 md:pl-80 md:pr-10 relative z-10">
        <div className="w-full space-y-16">
          <section className="flex flex-col md:flex-row gap-8 items-baseline">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="bg-surface-container-lowest p-8 rounded-[2rem] border border-outline-variant/10 min-h-[250px] animate-pulse">
                ...
                <div className="mt-8 pt-6 border-t border-outline-variant/10">
                  <div className="w-full h-2 bg-surface-container-high rounded-full mb-3"></div>
